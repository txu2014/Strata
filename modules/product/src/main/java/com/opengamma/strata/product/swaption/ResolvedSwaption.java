...
public final class ResolvedSwaption
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalDate> expiryDate = DirectMetaProperty.ofImmutable(
        this, "expiryDate", ResolvedSwaption.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<LocalTime> expiryTime = DirectMetaProperty.ofImmutable(
        this, "expiryTime", ResolvedSwaption.class, LocalTime.class);
    /**
    ...
    private final MetaProperty<ZoneId> expiryZone = DirectMetaProperty.ofImmutable(
        this, "expiryZone", ResolvedSwaption.class, ZoneId.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -816738431:  // expiryDate
          return ((ResolvedSwaption) bean).getExpiryDate();
        case -816254304:  // expiryTime
          return ((ResolvedSwaption) bean).getExpiryTime();
        case -816069761:  // expiryZone
          return ((ResolvedSwaption) bean).getExpiryZone();
        case -1770633379:  // underlying

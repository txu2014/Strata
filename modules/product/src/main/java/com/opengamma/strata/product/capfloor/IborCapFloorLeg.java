 ...
 * The cap/floor instruments are defined as a set of call/put options on successive Ibor index rates, i.e., 
 * Ibor caplets/floorlets.
 * <p>
 * The periodic payments generated by {@link #expand()} are caplets or floorlets depending on the data in this leg.
 ...
 * Thus the only one of {@code capSchedule} and {@code floorSchedule} must be non-empty. 
 */
@BeanDefinition
public final class IborCapFloorLeg
  ...
  //-------------------------------------------------------------------------
  /**
   * Expand Ibor cap/floor leg. 
   * 
   * @return the expanded Ibor cap/floor leg
   */
  @SuppressWarnings("null")
  public ExpandedIborCapFloorLeg expand() {
    ...
    return ExpandedIborCapFloorLeg.builder()

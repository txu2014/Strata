...
/**
 * The leg of a constant maturity swap (CMS) product. 
 * <p>
 * The class defines a single leg for CMS or CMS cap/floor paying a rate based on the observed value of a swap index, 
 * {@link SwapIndex}. 
 * <p>
 * The periodic payment periods generated by {@link #expand()} follow from {@link PeriodicSchedule} and resulting 
 * individual payments are CMS coupon, CMS caplet or CMS floorlet following on the rule below.
 * <p>
...
public final class CmsLeg
  ...
  public ExpandedCmsLeg expand() {
    ...
    for (int i = 0; i < adjustedSchedule.size(); i++) {
      ...
      LocalDate paymentDate = paymentDateOffset.adjust(period.getUnadjustedEndDate());
      cmsPeriodsBuild.add(CmsPeriod.builder()
          ...
          .cap(getCapSchedule().isPresent() ? cap.get(i) : null)
          .floor(getFloorSchedule().isPresent() ? floor.get(i) : null)
          .build());
    }

...
public final class ResolvedIborCapFloorLeg
  ...
  private final ImmutableList<IborCapFloorPeriod> capletFloorletPeriods;

  //-------------------------------------------------------------------------
  @ImmutableConstructor
  private ResolvedIborCapFloorLeg(
      PayReceive payReceive,
      List<IborCapFloorPeriod> capletFloorletPeriods) {
    ...
    Set<Currency> currencies =
        this.capletFloorletPeriods.stream().map(IborCapFloorPeriod::getCurrency).collect(Collectors.toSet());
    ArgChecker.isTrue(currencies.size() == 1, "Leg must have a single currency, found: " + currencies);
    Set<IborIndex> iborIndices =
        this.capletFloorletPeriods.stream().map(IborCapFloorPeriod::getIndex).collect(Collectors.toSet());
   ...
   */
  public ImmutableList<IborCapFloorPeriod> getCapletFloorletPeriods() {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableList<IborCapFloorPeriod>> capletFloorletPeriods = DirectMetaProperty.ofImmutable(
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<ImmutableList<IborCapFloorPeriod>> capletFloorletPeriods() {
      return capletFloorletPeriods;
    }
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<ResolvedIborCapFloorLeg> {
    ...
    private List<IborCapFloorPeriod> capletFloorletPeriods = ImmutableList.of();
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case -885469925:  // payReceive
          ...
          break;
        case 1504863482:  // capletFloorletPeriods
          this.capletFloorletPeriods = (List<IborCapFloorPeriod>) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
     ...
     * @return this, for chaining, not null
     */
    public Builder capletFloorletPeriods(List<IborCapFloorPeriod> capletFloorletPeriods) {
     ...
     * @return this, for chaining, not null
     */
    public Builder capletFloorletPeriods(IborCapFloorPeriod... capletFloorletPeriods) {

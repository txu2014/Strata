...
/**
 * An expanded Ibor cap/floor leg of an Ibor cap/floor product, with dates calculated ready for pricing.
 * <p>
 * This defines a single cap/floor leg for the cap/floor product.
 * Ibor cap/floor instruments are defined as a set of call/put options on successive Ibor index rates, i.e., 
 * Ibor caplets/floorlets.
 * <p>
 * All payments must be based on the same index and in the same currency. 
 */
@BeanDefinition
public final class ExpandedIborCapFloorLeg
  ...
  private ExpandedIborCapFloorLeg(
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code ExpandedIborCapFloorLeg}.
   * @return the meta-bean, not null
   */
  public static ExpandedIborCapFloorLeg.Meta meta() {
    return ExpandedIborCapFloorLeg.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(ExpandedIborCapFloorLeg.Meta.INSTANCE);
  }
   ...
   */
  public static ExpandedIborCapFloorLeg.Builder builder() {
    return new ExpandedIborCapFloorLeg.Builder();
  }

  @Override
  public ExpandedIborCapFloorLeg.Meta metaBean() {
    return ExpandedIborCapFloorLeg.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ExpandedIborCapFloorLeg other = (ExpandedIborCapFloorLeg) obj;
  ...
  public String toString() {
    ...
    buf.append("ExpandedIborCapFloorLeg{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PayReceive> payReceive = DirectMetaProperty.ofImmutable(
        this, "payReceive", ExpandedIborCapFloorLeg.class, PayReceive.class);
    /**
    ...
    private final MetaProperty<ImmutableList<IborCapletFloorletPeriod>> capletFloorletPeriods = DirectMetaProperty.ofImmutable(
        this, "capletFloorletPeriods", ExpandedIborCapFloorLeg.class, (Class) ImmutableList.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public ExpandedIborCapFloorLeg.Builder builder() {
      return new ExpandedIborCapFloorLeg.Builder();
    }

    @Override
    public Class<? extends ExpandedIborCapFloorLeg> beanType() {
      return ExpandedIborCapFloorLeg.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -885469925:  // payReceive
          return ((ExpandedIborCapFloorLeg) bean).getPayReceive();
        case 1504863482:  // capletFloorletPeriods
          return ((ExpandedIborCapFloorLeg) bean).getCapletFloorletPeriods();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ExpandedIborCapFloorLeg}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ExpandedIborCapFloorLeg> {
     ...
     */
    private Builder(ExpandedIborCapFloorLeg beanToCopy) {
    ...
    @Override
    public ExpandedIborCapFloorLeg build() {
      return new ExpandedIborCapFloorLeg(
          payReceive,
          capletFloorletPeriods);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(96);
      buf.append("ExpandedIborCapFloorLeg.Builder{");

 ...
 */
@BeanDefinition
public final class IborCapFloorPeriod
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code IborCapFloorPeriod}.
   * @return the meta-bean, not null
   */
  public static IborCapFloorPeriod.Meta meta() {
    return IborCapFloorPeriod.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(IborCapFloorPeriod.Meta.INSTANCE);
  }
   ...
   */
  public static IborCapFloorPeriod.Builder builder() {
    return new IborCapFloorPeriod.Builder();
  }

  @Override
  public IborCapFloorPeriod.Meta metaBean() {
    return IborCapFloorPeriod.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      IborCapFloorPeriod other = (IborCapFloorPeriod) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Currency> currency = DirectMetaProperty.ofImmutable(
        this, "currency", IborCapFloorPeriod.class, Currency.class);
    /**
     * The meta-property for the {@code notional} property.
     */
    private final MetaProperty<Double> notional = DirectMetaProperty.ofImmutable(
        this, "notional", IborCapFloorPeriod.class, Double.TYPE);
    /**
     * The meta-property for the {@code startDate} property.
     */
    private final MetaProperty<LocalDate> startDate = DirectMetaProperty.ofImmutable(
        this, "startDate", IborCapFloorPeriod.class, LocalDate.class);
    /**
     * The meta-property for the {@code endDate} property.
     */
    private final MetaProperty<LocalDate> endDate = DirectMetaProperty.ofImmutable(
        this, "endDate", IborCapFloorPeriod.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<LocalDate> unadjustedStartDate = DirectMetaProperty.ofImmutable(
        this, "unadjustedStartDate", IborCapFloorPeriod.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<Double> floorlet = DirectMetaProperty.ofImmutable(
        this, "floorlet", IborCapFloorPeriod.class, Double.class);
    /**
    ...
    private final MetaProperty<IborRateObservation> rateObservation = DirectMetaProperty.ofImmutable(
        this, "rateObservation", IborCapFloorPeriod.class, IborRateObservation.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public IborCapFloorPeriod.Builder builder() {
      return new IborCapFloorPeriod.Builder();
    }

    @Override
    public Class<? extends IborCapFloorPeriod> beanType() {
      return IborCapFloorPeriod.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 575402001:  // currency
          return ((IborCapFloorPeriod) bean).getCurrency();
        case 1585636160:  // notional
          return ((IborCapFloorPeriod) bean).getNotional();
        case -2129778896:  // startDate
          return ((IborCapFloorPeriod) bean).getStartDate();
        case -1607727319:  // endDate
          return ((IborCapFloorPeriod) bean).getEndDate();
        case 1457691881:  // unadjustedStartDate
          return ((IborCapFloorPeriod) bean).getUnadjustedStartDate();
        case 31758114:  // unadjustedEndDate
          return ((IborCapFloorPeriod) bean).getUnadjustedEndDate();
        case -1731780257:  // yearFraction
          return ((IborCapFloorPeriod) bean).getYearFraction();
        case -1540873516:  // paymentDate
          return ((IborCapFloorPeriod) bean).getPaymentDate();
        case -1367656183:  // caplet
          return ((IborCapFloorPeriod) bean).caplet;
        case 2022994575:  // floorlet
          return ((IborCapFloorPeriod) bean).floorlet;
        case 535324460:  // rateObservation
          return ((IborCapFloorPeriod) bean).getRateObservation();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code IborCapFloorPeriod}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<IborCapFloorPeriod> {
     ...
     */
    private Builder(IborCapFloorPeriod beanToCopy) {
    ...
    @Override
    public IborCapFloorPeriod build() {
      preBuild(this);
      return new IborCapFloorPeriod(
          currency,
          notional,
          startDate,
          endDate,
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(384);
      buf.append("IborCapFloorPeriod.Builder{");

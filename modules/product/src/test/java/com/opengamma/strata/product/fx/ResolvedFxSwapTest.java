...
public class ResolvedFxSwapTest {
  ...
  //-------------------------------------------------------------------------
  public void test_of() {
    ResolvedFxSwap test = ResolvedFxSwap.of(NEAR_LEG, FAR_LEG);
  ...
  public void converage() {
    ResolvedFxSwap test1 = ResolvedFxSwap.of(NEAR_LEG, FAR_LEG);
    ...
    ResolvedFxSwap test2 = ResolvedFxSwap.of(nearLeg, farLeg);

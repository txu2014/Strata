...
public final class IborFixingDepositCurveNode
  ...
  private LocalDate calculateEnd(LocalDate valuationDate, ReferenceData refData) {
    ResolvedIborFixingDeposit deposit = template.toTrade(valuationDate, BuySell.BUY, 0d, 0d).getProduct().resolve(refData);
  ...
  @Override
  public ResolvedIborFixingDepositTrade trade(LocalDate valuationDate, MarketData marketData, ReferenceData refData) {

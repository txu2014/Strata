...
public class SwaptionSabrSensitivityTest {
  ...
  public void test_convertedTo() {
    ...
    SwaptionSabrSensitivity expected = SwaptionSabrSensitivity.of(SWAP_CONV, DATE_TIME, SWAP_TENOR, USD,
        ALPHA_SENSI * rate, BETA_SENSI * rate, RHO_SENSI * rate, NU_SENSI * rate);
  ...
  public void coverage() {
    ...
    SwaptionSabrSensitivity test2 = SwaptionSabrSensitivity.of(
        FixedIborSwapConventions.USD_FIXED_6M_LIBOR_3M, dateUtc(2015, 4, 27), 10d, USD, 1.2d, -0.24d, 3.01d, 0.98d);
